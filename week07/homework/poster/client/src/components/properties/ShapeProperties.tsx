...
export default function ShapeProperties({ element }: Props) {
  ...
  return (
    <div className="space-y-5">
      <h3 className="font-medium text-gray-800">形状属性</h3>
      ...
      <div className="space-y-3">
        <h4 className="text-sm font-medium text-gray-700">描边颜色</h4>
        <div className="flex items-center gap-2">
          <input
            type="color"
      ...
      <div className="space-y-3">
        <h4 className="text-sm font-medium text-gray-700">描边宽度</h4>
